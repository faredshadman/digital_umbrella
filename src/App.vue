...
export default {
  ...
  methods: {
    handleDelete(id) {
      ...
      let isDeleted = confirm("Are you sure to delete this todo");
      // if true delete todo
      if (isDeleted) {
        let todos = this.todos.filter((item) => item.id !== id);
